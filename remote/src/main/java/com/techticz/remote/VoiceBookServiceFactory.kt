...
object VoiceBookServiceFactory {

    fun makeWeatherService(isDebug: Boolean): VoiceBookService {
        val okHttpClient = makeOkHttpClient(
            makeLoggingInterceptor(isDebug))
        return makeWeatherService(okHttpClient, makeGson())
    }

    private fun makeWeatherService(okHttpClient: OkHttpClient, gson: Gson): VoiceBookService {
        val retrofit = Retrofit.Builder()
            ...
            .build()
        return retrofit.create(VoiceBookService::class.java)
    }
